...
React → POST /api/forecast
    ↓
Python API validates request and looks up turbine
    ↓
...
- **Model/service error**: Returns 500 with error message
...
**Response:** Same format as `/api/forecast`
...
This script starts Python API and frontend concurrently.
